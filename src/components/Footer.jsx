        ...
        <div>
          ...
          <div className="mt-4 flex space-x-4">
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}>
              <svg
                className="w-[30px] h-[30px] fill-[#8e8e8e] hover:fill-[#ffffff] hover:shadow-lg hover:shadow-[#0284c7] p-1 rounded-xl shadow-sm shadow-[#0284c7] transition duration-300"
                viewBox="0 0 512 512"
