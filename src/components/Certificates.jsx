    ...
    return (
      <motion.a
        ...
        rel="noopener noreferrer"
         className="project-card group xl:h-[24vw] lg:w-[24vw] lg:h-[32vw] md:w-[32vw] h-[48vw] w-[48vw] text-slate-400 flex flex-col justify-center items-center hover:shadow-lg hover:shadow-[#0284c7] shadow-sm shadow-[#0285c786] transition duration-300"
      ...
      >
        ...
        />
        <h1 className="md:text-2xl text-xl px-2 font-bold text-center group-hover:text-slate-100 mt-2 transition duration-300">
          {certName}
        </h1>
